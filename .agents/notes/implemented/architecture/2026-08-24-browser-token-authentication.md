...
The shipped CLI defaults to loopback and keeps `--host 0.0.0.0` an explicit opt-in. Authentication does not imply supported network deployment, TLS, forwarding-header interpretation, or proxy configuration.
